...
### 4. ปุ่มฮาร์ดแวร์รีเซ็ต Wi-Fi (Hardware Wi-Fi Reset Button)
- เพิ่มปุ่มกดจริง (Hardware Switch) สำหรับรีเซ็ตการตั้งค่า Wi-Fi โดยต่อเข้ากับขา D4 (GPIO 4)
- เมื่อกดค้าง 3 วินาที ไฟ LED จะเปลี่ยนเป็นสีแดง และระบบจะเข้าสู่โหมด Access Point (AP) โดยอัตโนมัติ
