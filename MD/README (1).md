...
|---|---|---|---|
| 1 | ตั้งค่า WiFi ของเครื่อง | Local | esp32 เสิร์ฟเอง ที่ `192.168.4.1` |
| 2 | ตั้งค่า WiFi ที่จะเชื่อมต่อ | Local | esp32 เสิร์ฟเอง ที่ `192.168.4.1` |
| 3 | Dashboard ควบคุมเครื่อง (Local) | Local | esp32 เสิร์ฟเอง ที่ `192.168.4.1` |
...
**8. ตั้งเวลาให้อาหารอัตโนมัติ** — ตั้งตารางเวลาสูงสุด 32 รอบ/วัน กำหนดเวลา ปริมาณ และเปิด/ปิดแต่ละรอบ บันทึกลง Firebase และแจ้งเครื่องผ่าน HiveMQ
